...
#Conversão de XMLs de NF-E Mod 55 e NFC-E Mod 65 contidos na própria pasta em um arquivo CSV tabelado, podendo ser aberto via Excel.
#Necessário Python 3.0+
#Necessário Pandas, CSV, BeautifulSoup e lxml
#Thomaz Sachetto Silva - 32 9 8409-5689 - v1.0.0 - 2021/09
        ...
        with open(xml, 'r', encoding='utf8') as f:
            ...
            for item in items:
               ...
               #cst do cofins
                ...
                pd.DataFrame(dataList).to_csv("TABELA_XML.csv", quoting=csv.QUOTE_NONNUMERIC, index=False, header=False, sep=';')
